...
export class Vec3 {
  ...
  toGL() {
    if (!this.arr) this.arr = new Array(3);
    this.arr[0] = this.x;
    this.arr[1] = this.y;
    this.arr[2] = this.z;
    return this.arr;
...
export class Mat3 {
  ...
  toGL() {
    if (!this.arr) this.arr = new Array(9);
    this.arr[0] = this.row0_0;
    this.arr[1] = this.row1_0;
    this.arr[2] = this.row2_0;
    this.arr[3] = this.row0_1;
    this.arr[4] = this.row1_1;
    this.arr[5] = this.row2_1;
    this.arr[6] = this.row0_2;
    this.arr[7] = this.row1_2;
    this.arr[8] = this.row2_2;
    return this.arr;
  }
